...
public class Settings {
	...
	/**
	 * Loads the config file that is specified in the Property
	 * <I>configFile</I>. If it cannot find the file, it will ask to create a
	 * new default file with <I>writeDefaultConfig()</I>.
	 */
	private void load() {
		try {
